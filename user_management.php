...
// --- Fetch and Group All Users by Role ---
$allUsers = $conn->query("SELECT userID, Name, email, contactNo, role FROM users ORDER BY userID DESC")->fetch_all(MYSQLI_ASSOC);
                                ...
                                <tbody>
                                    ...
                                    <tr class="user-row bg-white border-b">
                                        ...
                                        <td class="px-6 py-4 text-center space-x-4">
                                            ...
                                            <form method="POST" action="user_management.php" onsubmit="return confirm('Are you sure?');" class="inline-block">
