...
// --- (NEW) Handle Deleting a SINGLE historical booking ---
...
// --- (NEW) Handle Clearing ALL history ---
...
if (isset($_GET['cancel_booking_id'])) {
    ...
    $findBookingStmt = $conn->prepare("SELECT availabilityID, status FROM caregiverbooking WHERE bookingID = ? AND patientID = ?");
    ...
    <div class="flex min-h-screen">
        <aside class="w-64 bg-white border-r">
            ...
            <nav class="px-4 space-y-2">
                ...
                <a href="my_bookings.php" class="flex items-center space-x-3 px-4 py-3 bg-purple-100 text-dark-orchid rounded-lg"><i class="fa-solid fa-book-bookmark w-5"></i><span>My Bookings</span></a>
                            ...
                            <?php foreach ($upcomingBookings as $booking): ?>
                                <div class="bg-white p-5 rounded-lg shadow-sm flex justify-between items-center">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500"><i class="fa-solid fa-tags mr-2"></i><?php echo htmlspecialchars($booking['bookingType']); ?> booking</p>
                                    </div>
                                    <div class="text-right">
                                         <?php
                                            $statusClass = '';
