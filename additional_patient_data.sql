-- Add remaining sample data for patients
USE healthcare;

-- Add prescriptions for patients using correct appointment IDs
...
(28, 28, 'Metformin 500mg - Twice daily, Glipizide 5mg - Once daily', 'Take before meals. Check blood sugar regularly.', '2025-07-15'),
...
(19, 28, 'Vitamin D3 1000IU - Once daily', 'Take with meals for better absorption.', '2025-07-15');

-- Add caregiver bookings for patients (first check if availabilities exist)
INSERT IGNORE INTO caregiver_availability (availabilityID, careGiverID, startDate, endDate, startTime, endTime, status) VALUES
(1, 25, '2025-08-20', '2025-08-27', '08:00:00', '16:00:00', 'Booked'),
(2, 32, '2025-08-24', '2025-08-24', '10:00:00', '18:00:00', 'Booked'),
(3, 25, '2025-09-01', '2025-09-30', '09:00:00', '17:00:00', 'Booked');
...
-- Add more available slots for future bookings
