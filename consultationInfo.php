...
// --- Fetch Scheduled Consultations with Patient Age ---
$query = "
    SELECT 
        a.appointmentID,
        a.patientID,
    ...
    LEFT JOIN patient p ON u.userID = p.patientID -- Use LEFT JOIN for robustness
...
<head>
    ...
    <style>
        ...
        .consultation-card {
            ...
            /* (MODIFIED) Ensure card content is spaced out vertically */
            display: flex;
    ...
    <div class="flex min-h-screen">
        <aside class="w-64 bg-white border-r">
            ...
            <nav class="px-4">
                ...
                <a href="consultationInfo.php" class="flex items-center space-x-3 px-4 py-3 bg-purple-100 text-dark-orchid rounded-lg"><i class="fa-solid fa-laptop-medical w-5"></i><span>Consultations</span></a>
        ...
        <main class="flex-1 p-8">
            ...
            <div class="space-y-10">
                <?php function render_consultation_card($consult) { ?>
                    <div class="consultation-card bg-white p-6 rounded-lg shadow-orchid-custom">
                        <div>
                        ...
                        <div class="flex flex-col space-y-2 mt-4">
                            ...
                            <a href="createPrescription.php?appointment_id=<?php echo $consult['appointmentID']; ?>" class="w-full text-center font-medium text-dark-orchid bg-purple-100 hover:bg-purple-200 px-4 py-2 rounded-lg transition">
                                <i class="fa-solid fa-file-prescription mr-2"></i>Create Prescription
                            </a>
                        </div>
                    </div>
                <?php } ?>
                ...
                <div class="text-center py-20 bg-white rounded-lg shadow-orchid-custom">
